...
function getUiText(lang: Lang) {
  if (lang === "fr") {
    return {
      ...
      modeMate5Help: "Attaque tactique : un scénario offensif avec un objectif précis.",
      modeProtectHelp: "Protégez Macroute : lfi veut sa peau.",
      modeBattleHelp: "Bataille Royale : Tous les coups sont permis.",
  ...
  if (lang === "de") {
    return {
      ...
      modeMate5Help: "Taktischer Angriff: klare Linie, volle Härte – quasi wie ein AfD-Antrag im Plenum: viel Geschrei, kein Plan, aber Hauptsache, die eigenen Leute klatschen.",
      modeProtectHelp: "Schütze deinen König – aber bitte nicht den von CDU/CSU. Halt dem Druck stand wie Olaf Scholz im Untersuchungsausschuss, und verteidige deine Stellung – auch wenn die Ampel dir gerade den Boden unter den Füßen wegkoaliert.",
      modeBattleHelp: "Battle Royal – wie Fraktionssitzung der Union nach Merkel: wilder, ungleicher, und am Ende gewinnt eh der, der zuerst 'Brandmauer' ruft.",
  ...
  return {
    ...
    modeMate5Help: "Tactical attack: an attacking scenario with a sharp objective.",
    modeProtectHelp: "Protect your king: survive under pressure and hold your ground.",
    modeBattleHelp: "Wild battle: a more dynamic and unpredictable game.",
